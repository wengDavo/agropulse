					...
					<article className="rounded-2xl py-7 px-4 relative">
						...
						<div className="grid gap-y-4">
							...
							<div className="grid gap-y-2">
								<button className="bg-green-500 w-full rounded-3xl outline-none text-white p-2 cursor-pointer">
									<Link to="/auth/signup">Sign up</Link>
								</button>
								<button className="border border-green-30 w-full rounded-3xl outline-none text-green-30 p-2 cursor-pointer">
